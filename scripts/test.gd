...
func _ready():
	...
	var character = Character.new(get_parent(),get_parent().get_node("Sprite2D"),get_parent().get_node("CollisionShape2D"),get_parent().get_node("AnimationPlayer"),get_parent().get_node("AnimationTree"))
